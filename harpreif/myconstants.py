...
INITIAL_EPSILON = 0.4                # the starting epsilon of the learning phase in training
...
REPLAY_MEMORY = 10000                # the number of elements to keep in the replay memory
...
STEPS_MAX = 30                       # The maximum allowed step for each episode
...
ITERATIONS_PER_EPSILON_DECAY = 6000  # Number of iterations before increasing greediness
