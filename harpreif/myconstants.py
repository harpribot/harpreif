...
NUMBER_OF_IMAGES_FOR_DECAY = 300     # number of images before halving the learning rate
...
OBSERVE = 1000                       # the number of iterations we use to observe
REPLAY_MEMORY = 1000                 # the number of elements to keep in the replay memory
...
NUM_BINS = 32                        # Number of bins in which the histogram is discretised
